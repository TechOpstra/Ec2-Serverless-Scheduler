...
module "start_event" {
  ...
  schedule_expression = "cron(30 2 ? JAN-DEC MON-FRI 2025)" # 8:00 AM according to IST
...
module "stop_event" {
  ...
  schedule_expression = "cron(00 11 ? JAN-DEC MON-FRI 2025)" # 5:00 PM according to IST
